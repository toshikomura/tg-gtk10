...
\input{historia_e_concetios_de_bibliotecas}

% ----------------------------------------------------------
% Proposta do Trabalho
% ----------------------------------------------------------
\chapter[Bibliotecas do Ruby e Segurança]{Bibliotecas do Ruby e Segurança}
\label{chapter:bibliotecas_do_ruby_e_segurança}
\input{bibliotecas_do_ruby_e_seguranca}
...
\input{apendice_classificacao_de_bibliotecas}
...
\chapter[Uso da Ferramenta gem]{Uso da Ferramenta gem}
\label{chapter:uso_da_ferramenta_gem}
\input{apendice_uso_da_ferramenta_gem}
...
\chapter[API do Google Maps]{API do Google Maps}
\label{chapter:api_do_google_maps}
\input{apendice_api_do_google_maps}
