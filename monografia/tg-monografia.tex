...
% ----------------------------------------------------------
\chapter[Conceitos de Bibliotecas]{História e Conceitos de Bibliotecas}
\label{chap:historico_e_concetios_de_bibliotecas}
\input{concetios_de_bibliotecas}
...
\label{chap:ruby_e_suas_bibliotecas}
\input{ruby_e_suas_bibliotecas}

% ----------------------------------------------------------
% Implementação
% ----------------------------------------------------------
\chapter[Criação e adaptação de bibliotecas do Ruby]{Criação e adaptação de bibliotecas do Ruby}
\label{chap:criacao_e_adaptacao_de_bibliotecas_do_ruby}
\input{criacao_e_adaptacao_de_bibliotecas_do_ruby}
