...
% Implementação
% ----------------------------------------------------------
\chapter[Criação de bibliotecas do Ruby On Rails]{Criação de bibliotecas do Ruby On Rails}
\label{chapter:criacao_de_bibliotecas_do_ruby_on_rails}
\input{criacao_de_bibliotecas_do_ruby_on_rails}


\chapter[Adaptação de bibliotecas do Ruby On Rails]{Adaptação de bibliotecas do Ruby On Rails}
\label{chapter:adaptacao_de_bibliotecas_do_ruby_on_rails}
\input{adaptacao_de_bibliotecas_do_ruby_on_rails}
